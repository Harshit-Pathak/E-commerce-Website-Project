...
<meta charset="utf-8">
<title>Laptops</title>
<link href="Laptop design.css" rel="stylesheet" type="text/css">
</head>
...
<body>
  ...
  <div class="mySlides fade" align="center">
    ...
    <img src="Acer.jpg" width="500" height="400" style="width:100%">
   
  </div>

  <div class="mySlides fade" align="center">
    <div class="numbertext"></div>
    <img src="Apple laptop.jpeg" width="500" height="400" style="width:100%">
    
  </div>

  <div class="mySlides fade" align="center">
    <div class="numbertext"></div>
    <img src="Asuslaptop.jpg" width="300" height="400" style="width:100%">
  ...
  <div class="mySlides fade" align="center">
    <div class="numbertext"></div>
    <img src="Dell laptop.jpg" width="100" height="400" style="width:100%">
   
  </div>
	
    <div class="mySlides fade" align="center">
    <div class="numbertext"></div>
    <img src="hplaptop.jpg" width="100" height="400" style="width:100%">
    ...
    <div class="mySlides fade" align="center">
    <div class="numbertext"></div>
    <img src="lenovo laptop.jpg" width="100" height="400" style="width:100%">
...
function showSlides() {
  ...
  padding: 9px 7px; width: 10.7% ; padding-top:3px; padding-bottom:2px; border-radius:11px;" align="right"   >
             </form>
		</ul>
		</div>
