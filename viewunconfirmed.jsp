...
if(name==null)
{
	response.sendRedirect("admin_login.jsp?remarks=loginfirst");
}
%>
<body>
...
<tr align="left">
	...
	<td align="center"><font size =3 color='red' face='tahoma'>Delete</font></td>
	</tr>
...
try
{
	...
	PreparedStatement ps=con.prepareStatement("select * from orders where ostatus='unconfirmed' order by odate desc");
...
%>
	<tr><td align="right" colspan="6"><input type="hidden" name="pno" value=<%=pageno%>><center><input type="submit" value="Delete" class="btn"></td></tr></center>
</form>
</table>
