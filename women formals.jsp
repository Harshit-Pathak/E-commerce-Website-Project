...
<head>
<meta charset="utf-8">
<title>Womens Formals</title>
<link href="women formals.css" rel="stylesheet" type="text/css">
</head>
...
<div class="slideshow-container"><br><br><br><br>
  ...
  <div class="mySlides fade" align="center">
    ...
    <img src="womenformal1.jpg"width="500" height="400" style="width:100%">
   
  </div>

  <div class="mySlides fade" align="center">
    <div class="numbertext"></div>
    <img src="womenformal2.jpg" width="500" height="400" style="width:100%">
    
  </div>

  <div class="mySlides fade" align="center">
    <div class="numbertext"></div>
    <img src="womenformal3.jpg" width="500" height="400" style="width:100%">
